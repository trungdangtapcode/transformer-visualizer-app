...
export const inputTextExample = [
	'Trực quan hóa dữ liệu giúp người dùng',
	'Trí tuệ nhân tạo đang thay đổi thế',
	'Khi con tàu vũ trụ đang tiến gần',
	'Trên hành tinh hoang vắng họ phát hiện',
	'Việt Nam là quốc gia có nền'
];
...
export const modelMetaMap: Record<string, ModelMetaData> = {
	gpt2: { layer_num: 12, attention_head_num: 12, dimension: 768, chunkTotal: 53 },
